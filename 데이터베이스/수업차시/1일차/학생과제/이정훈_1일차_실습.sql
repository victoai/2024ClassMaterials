...
select M_name,M_ID,M_BIRTHDAY,M_POINT from member_tbl_11 where M_NAME = '박해수';
...
--( 포인트가 NULL인 고객 조회: 포인트가 입력되지 않은 고객을 말함 ) 
...
--14. 고객등급이 중복되지 않도록 고객등급을 조회하는 쿼리를 작성하시
...
--6. 고객등급이 ‘01’, ‘02’ 이 아닌 고객의 아이디, 이름, 등급 정보를 조회하시오
--( NOT IN 연산자 사용 해 주세요)
...
--8. 생일이 2004-05-01이전에 태어나거나 고객등급이 ‘03’인 고객의 아이디, 이름, 생일 정보를 조회하시
